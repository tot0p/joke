...
def main() :
    ...
    if os.path.exists('docs/api/joke') :
        with open('data.json', 'r', encoding='utf-8') as f :
            ...
            write_file('docs/api/joke/random/index.json', json.dumps(data[random.randint(0,len(data)-1)], ensure_ascii=False, indent=4))
        if os.path.exists('docs/api/jokes/lang'):
            for lang in os.listdir('docs/api/jokes/lang'):
                with open(f'docs/api/jokes/lang/{lang}/index.json', 'r', encoding='utf-8') as f:
                    ...
                    write_file(f'docs/api/joke/random/{lang}/index.json', json.dumps(data[random.randint(0,len(data)-1)], ensure_ascii=False, indent=4))
